...
A ***set*** (might also be referred to as a family at times) is a collection of elements. A set's elements can be characterized by either listing the elements or stating some property that the elements fulfill.

The ***empty set*** is the set containing no elements. The empty set is given by this notation: $\emptyset$.
