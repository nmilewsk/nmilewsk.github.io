...
>
> [Symmetric](#M2):
> $d(x,y)=\\sqrt{(x_{1}-y_{1})^2 + (x_{2}-y_{2})^2} = \\sqrt{(-1(y_{1}-x_{1}))^2 + (-1(y_{2}-x_{2}))^2} = \\sqrt{(-1)^2(y_{1}-x_{1})^2 + (-1)^2(y_{2}-x_{2})^2} = \\sqrt{(y_{1}-x_{1})^2 + (y_{2}-x_{2})^2} = d(y,x)$
> 
> [Triangle Inequality](#M3):
> WTS: $d(x,z)=\\sqrt{(x_{1}-z_{1})^2 + (x_{2}-z_{2})^2} \\leq d(x,y)=\\sqrt{(x_{1}-y_{1})^2 + (x_{2}-y_{2})^2} + d(y,z)=\\sqrt{(y_{1}-z_{1})^2 + (y_{2}-z_{2})^2}.$
> First let $a_{i} = (x_{i}-y_{i})^2$ and $b_{i} = (y_{i}-z_{i})^2,$ then $(x_{i}-z_{i})^2 = (a_{i}+b_{i})^2.$
> Our triangle inequality then turns to showing that $\\sqrt{(a_{1}+b_{1})^2 + (a_{2}+b_{2})^2} \\leq \\sqrt{a_{1}^2 + a_{2}^2} + \\sqrt{b_{1}^2 + b_{2}^2}.$
...
> After cancelling, we just need to show $a_{1}b_{1} + a_{2}b_{2} \\leq \\sqrt{(a_{1}^2 + a_{2}^2)(b_{1}^2 + b_{2}^2)}.$
> Because a square root is a non-negative function, we can take $(a_{1}b_{2}-a_{2}b_{1})^2 \\geq 0.$
> $\\implies a_{1}^2b_{2}^2+a_{2}^2b_{1}^2-2a_{1}a_{2}b_{1}b_{2} \\geq 0 \\implies a_{1}^2b_{2}^2+a_{2}^2b_{1}^2 \\geq 2a_{1}a_{2}b_{1}b_{2}.$
> Note now that $(a_{1}^2+a_{2}^2)(b_{1}^2+b_{2}^2)= a_{1}^2b_{1}^2+a_{2}^2b_{2}^2 + a_{1}^2b_{2}^2+a_{2}^2b_{1}^2.$ If we subtract $(a_{1}b_{1}+a_{2}b_{2})^2$ (which is non-negative), we get
> $\\implies (a_{1}^2+a_{2}^2)(b_{1}^2+b_{2}^2) \\geq a_{1}^2b_{1}^2+a_{2}^2b_{2}^2 + 2a_{1}a_{2}b_{1}b_{2} = (a_{1}b_{1} + a_{2}b_{2})^2.$
> Finally if we take the square root of both sides (since both are non-negative), we get that $a_{1}b_{1} + a_{2}b_{2} \\leq \\sqrt{(a_{1}^2 + a_{2}^2)(b_{1}^2 + b_{2}^2)}$
> $\\implies d(x,z) \\leq d(x,y) + d(y,z).$
> Thus, $d$ is a metric, and by definition $(\\mathbb{R}^2, d)$ is a metric space. $\\qed$
